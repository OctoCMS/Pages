...
trait PageVersionStoreBase
{
    ...
    */
    public function getById($value, $useConnection = 'read')
    {
        ...
        $query = new Query($this->getNamespace('PageVersion').'\Model\PageVersion', $useConnection);
        $query->select('*')->from('page_version')->limit(1);
        $query->where('`id` = :id');
        $query->bind(':id', $value);
    ...
    public function getTotalForPageId($value, $options = [], $useConnection = 'read')
    {
        ...
        $query = new Query($this->getNamespace('PageVersion').'\Model\PageVersion', $useConnection);
        $query->from('page_version')->where('`page_id` = :page_id');
        ...
        try {
            ...
            throw new StoreException('Could not get count of PageVersion by PageId', 0, $ex);
        }
    }
    ...
    public function getByPageId($value, $options = [], $useConnection = 'read')
    {
        ...
        try {
            $query->execute();
            return new PageVersionCollection($query->fetchAll());
        } catch (PDOException $ex) {
            throw new StoreException('Could not get PageVersion by PageId', 0, $ex);
        }
    ...
    public function getTotalForContentItemId($value, $options = [], $useConnection = 'read')
    {
        ...
        $query = new Query($this->getNamespace('PageVersion').'\Model\PageVersion', $useConnection);
        $query->from('page_version')->where('`content_item_id` = :content_item_id');
        ...
        try {
            ...
            throw new StoreException('Could not get count of PageVersion by ContentItemId', 0, $ex);
        }
    }
    ...
    public function getByContentItemId($value, $options = [], $useConnection = 'read')
    {
        ...
        try {
            ...
            throw new StoreException('Could not get PageVersion by ContentItemId', 0, $ex);
        }
    ...
    public function getTotalForUserId($value, $options = [], $useConnection = 'read')
    {
        ...
        $query = new Query($this->getNamespace('PageVersion').'\Model\PageVersion', $useConnection);
        $query->from('page_version')->where('`user_id` = :user_id');
        ...
        try {
            ...
            throw new StoreException('Could not get count of PageVersion by UserId', 0, $ex);
        }
    }
    ...
    public function getByUserId($value, $options = [], $useConnection = 'read')
    {
        ...
        try {
            ...
            throw new StoreException('Could not get PageVersion by UserId', 0, $ex);
        }
    ...
    public function getTotalForImageId($value, $options = [], $useConnection = 'read')
    {
        ...
        $query = new Query($this->getNamespace('PageVersion').'\Model\PageVersion', $useConnection);
        $query->from('page_version')->where('`image_id` = :image_id');
        ...
        try {
            ...
            throw new StoreException('Could not get count of PageVersion by ImageId', 0, $ex);
        }
    }
    ...
    public function getByImageId($value, $options = [], $useConnection = 'read')
    {
        ...
        try {
            ...
            throw new StoreException('Could not get PageVersion by ImageId', 0, $ex);
        }
